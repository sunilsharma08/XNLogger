#
#  Be sure to run `pod spec lint NetworkLogger.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "NetworkLogger"
  s.version      = "0.0.1"
  s.summary      = "A short description of NetworkLogger."
  ...
  s.homepage     = "https://github.com/sunilsharma08"
  ...
  s.source_files  = "NetworkLogger/**/*.{swift,h,m}"
  ...
  # s.resource  = "icon.png"
  s.resources = "NetworkLogger/UI/**/*.{storyboard,xib}"
